      ...
      <div className="h-screen flex items-center justify-center bg-background relative z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl sm:text-5xl lg:text-6xl mb-6 text-primary font-deuterium-ultra">
              Services
            </h2>
            <h3 className="text-2xl sm:text-3xl mb-8 text-accent font-deuterium-ultra">Where strategy meets craft</h3>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  >
                    <motion.div
                      ...
                      className="w-20 h-20 bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center mb-8"
                    >
                      <service.icon size={40} className={service.iconColor} />
                    </motion.div>

                    <div>
                      <h3 className={`text-3xl sm:text-4xl lg:text-5xl mb-6 ${service.textColor} font-deuterium-ultra`}>
                        {service.title}
                      </h3>
                    ...
                    <div className="space-y-4">
                      {service.features.map((feature, featureIndex) => (
                        ...
                        >
                          <div className={`w-3 h-3 ${service.bgClass === 'service-marketing' ? 'bg-primary' : 'bg-white'} mr-4 flex-shrink-0`}></div>
                  ...
                  >
                    <motion.div
                      ...
                      className={`w-64 h-64 sm:w-80 sm:h-80 border-4 ${service.bgClass === 'service-marketing' ? 'border-primary' : 'border-white/30'} flex items-center justify-center`}
                    >
                      <motion.div
                        animate={{ rotate: 360 }}
                        transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                        className={`w-32 h-32 sm:w-40 sm:h-40 ${service.bgClass === 'service-marketing' ? 'bg-primary' : 'bg-white/20'} flex items-center justify-center`}
                      >
